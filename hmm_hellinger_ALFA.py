...
plt.title("Anomaly score (dataset ALFA)")
...
plt.title("Grafico di precision (dataset ALFA)")
...
plt.title("Grafico di recall (dataset ALFA)")
plt.xlabel("Threshold")
plt.ylabel("Recall")
plt.show()
...
plt.title("Grafico di F1 score (dataset ALFA)")
plt.xlabel("Threshold")
plt.ylabel("F1 score")
plt.show()
...
plt.title("Grafico di accuracy (dataset ALFA)")
plt.xlabel("Threshold")
plt.ylabel("Accuracy")
plt.show()
...
plt.title("Grafico del True Positive Rate (dataset ALFA)")
plt.xlabel("Threshold")
plt.ylabel("TPR")
plt.show()
...
plt.title("Grafico del False Positive Rate (dataset ALFA)")
plt.xlabel("Threshold")
plt.ylabel("FPR")
plt.show()
